#ifndef LIBRARIES_FURBY_FURBYFTPSERVER_H_
#define LIBRARIES_FURBY_FURBYFTPSERVER_H_
#include "../FurbyConstants.h"

#include <SimpleFTPServer.h>
FtpServer ftpSrv;   //set #define FTP_DEBUG in ESP8266FtpServer.h to see ftp verbose on serial;

class FurbyFtpServer {
public:
	...
	static void init(){
		...
		ftpSrv.begin("furby","furby");    //username, password for ftp.   (default 21, 50009 for PASV)
